...
const Banner = () => {
  return (
    <div className='md:flex justify-between items-center my-16'>
      <div className="basis-1/2 sm:px-4 sm:py-4">
        ...
        <p className='text-sm'>The Brits have really outdone themselves with Lotus simply because of how exquisite their cars really are. The best part about them is that the Lotus cars are quite rare, meaning that you’ll always be at the center of attention when you roll up in one.</p>
